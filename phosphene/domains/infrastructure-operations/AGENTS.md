# AGENTS.md (domain stub) — <infrastructure-operations>
...
- `infra-spec` artifacts (deployment/runtime topology, config surfaces, environment contracts, runbooks)

## Operating boundary

- Use the `<infrastructure-operations>` tag to indicate scope/boundaries in handoffs.
...
- Artifacts for this domain live in canonical `output/` and `signals/` areas within the repo.
  - Control scripts live under: `.codex/skills/phosphene/amaranth/infrastructure-operations/modulator/scripts/`
