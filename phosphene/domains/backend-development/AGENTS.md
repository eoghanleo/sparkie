# AGENTS.md (domain stub) — <backend-development>
...
- `backend-implementation` artifacts (service logic, integrations, data access, jobs/workers)

## Operating boundary

- Use the `<backend-development>` tag to indicate scope/boundaries in handoffs.
...
- Artifacts for this domain live in canonical `output/` and `signals/` areas within the repo.
  - Control scripts live under: `.codex/skills/phosphene/amaranth/backend-development/modulator/scripts/`
