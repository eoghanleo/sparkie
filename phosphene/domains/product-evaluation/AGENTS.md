# AGENTS.md (domain stub) — <product-evaluation>
...
- `evaluation` artifacts (readiness rubric + eval harness gates)

## Operating boundary

- Use the `<product-evaluation>` tag to indicate scope/boundaries in handoffs.
...
- Artifacts for this domain live in canonical `output/` and `signals/` areas within the repo.
  - Control scripts live under: `.codex/skills/phosphene/cadmium/product-evaluation/modulator/scripts/`
