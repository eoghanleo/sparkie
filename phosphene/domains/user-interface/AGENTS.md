# AGENTS.md (domain stub) — <user-interface>

Primary domain: `<user-interface>`

This domain uses the canonical PHOSPHENE handoff at `phosphene/AGENTS.md`.

## What you produce

- `ui-spec` artifacts (screens, flows, interaction contracts)

## Operating boundary

- Use the `<user-interface>` tag to indicate scope/boundaries in handoffs.
...
- Artifacts for this domain live in canonical `output/` and `signals/` areas within the repo.
  - Control scripts live under: `.codex/skills/phosphene/amaranth/user-interface/modulator/scripts/`
