# AGENTS.md (domain stub) — <product-vision>
...
- `product-vision` artifacts (primary vision + alternates; constraints + falsifiers)

## Operating boundary

- Use the `<product-vision>` tag to indicate scope/boundaries in handoffs.
...
- Artifacts for this domain live in canonical `output/` and `signals/` areas within the repo.
  - Control scripts live under: `.codex/skills/phosphene/beryl/product-vision/modulator/scripts/`
